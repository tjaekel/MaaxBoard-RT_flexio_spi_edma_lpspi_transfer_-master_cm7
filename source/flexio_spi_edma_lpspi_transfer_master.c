...
#define FLEXIO_SPI_SOUT_PIN        03U				//J1, pin 33	MOSI
...
int main(void)
{
    ...
    PRINTF("This example use one FLEXIO SPI as master and LPSPI2 instance as slave on MaaxBoard-RT.\r\n");
    ...
    PRINTF("FLEXIO_SPI_master -- LPSPI2_slave\r\n");
    PRINTF(" CLK  J1,p13      --  CLK  J1,p8  - SCLK - SCLK\r\n");
    PRINTF(" PCS  J1,p11      --  PCS  J1,p10 - PCS  - PCS\r\n");
    PRINTF(" SOUT J1,p33      --  SIN  J1,p31 - MOSI - MOSI\r\n");
    PRINTF(" SIN  J1,p32      --  SOUT J1,p29 - MISO - MISO\r\n");
